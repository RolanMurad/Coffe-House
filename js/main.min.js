...
//!Tabs
const s=Array.from(document.querySelectorAll("[data-tab]")),a=document.querySelectorAll("[data-tab-content]");
//!Adding class
s[0].classList.add("active");let l=s[0];function c(e){e.preventDefault;!function(e){if(e.classList.contains("active"))return;l.classList.remove("active"),e.classList.add("active"),l=e}(e.target)}s.forEach((e=>{e.addEventListener("click",c),e.addEventListener("click",(function(){a.forEach((function(e){e.classList.add("hidden")}));document.querySelector("#"+this.dataset.tab).classList.remove("hidden")}))})),
//!Slick-slider
$(".reviews__slider").slick({
//!Main settings
arrows:!1,dots:!0,autoplay:!0,infinite:!0,slidesToShow:1,slidesToScroll:1,infinite:!0})}));